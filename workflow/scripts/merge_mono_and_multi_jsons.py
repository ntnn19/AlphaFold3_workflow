...
def main(monomers_dir,multimers_dir,output_dir):
    ...
    monomer_files = list(glob.glob(monomer_patterns))
    print("monomer_files=",monomer_files[:10])
    multimer_files = list(glob.glob(multimer_patterns))
    print("multimer_files=",multimer_files[:10])
